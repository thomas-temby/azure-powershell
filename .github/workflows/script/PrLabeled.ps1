...
"@
    "Module Onboard" = @"
This pull request introduces a **new module** which requires onboarding into the MAR Manifest.

Please ensure this module is added to the **MAR manifest** for first release.

Follow the **First Release onboarding guide** here:
https://eng.ms/docs/cloud-ai-platform/azure-core/azure-experiences-and-ecosystems/azure-portal-and-client-tools-ruhim/azure-cli-tools-azure-cli-powershell-and-terraform/azure-cli-tools/onboarding/azurepowershell/release#Firstrelease
"@
    "Legacy" = @" 
